...
## 简介
本项目是一个为 VS Code 设计的主题扩展包，旨在复刻 IntelliJ IDEA 新用户界面的视觉风格。该扩展包已更新品牌信息，当前包名为 `intellij-idea-new-ui-pretty-ferrymo`，发布者为 `ferrymo`，显示名称为“IntelliJ IDEA New UI Ferrymo”。项目特别针对 Java 开发进行了优化，以提升在 Java 语言环境下的代码可读性与开发体验。
